...
class DQNAgent(BaseAgent):
    ...
    def __init__(self, state_size, action_size, config=None):
        ...
        # Q-Networks
        self.policy_net = DQN(state_size, action_size, self.hidden_sizes).to(self.device)
        self.target_net = DQN(state_size, action_size, self.hidden_sizes).to(self.device)
    ...
    def train_step(self, state=None, action=None, reward=None, next_state=None, done=None):
        """

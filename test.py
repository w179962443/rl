...
def test_cartpole(args):
    ...
    for episode in range(args.episodes):
        ...
        print(f"Episode {episode+1:3d} | Reward: {episode_reward:7.2f} | Steps: {steps:4d}")
...
def test_pong(args):
    ...
    for episode in range(args.episodes):
        ...
        total_rewards.append(episode_reward)
        print(f"Episode {episode+1:3d} | Reward: {episode_reward:7.2f} | Steps: {steps:5d}")
...
def test_snake(args):
    ...
    for episode in range(args.episodes):
        ...
        print(f"Episode {episode+1:3d} | Reward: {episode_reward:7.2f} | Length: {snake_length:2d} | Steps: {steps:3d}")
